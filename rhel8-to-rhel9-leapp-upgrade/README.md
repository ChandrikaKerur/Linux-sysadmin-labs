...
![Red Hat Leapp lab](screenshots/01-lab-launch.png)
...
![RHEL 8 baseline](screenshots/02-rhel8-baseline-and-repos.png)
...
![DNF update](screenshots/03-system-update-in-progress.png)
...
![Leapp version](screenshots/04-leapp-version.png)
...
![Leapp preupgrade](screenshots/05-leapp-preupgrade-scan.png)
...
![Leapp report](screenshots/06-leapp-report-inhibitor.png)
...
![Kernel inhibitor details](screenshots/07-kernel-inhibitor-details.png)
...
![Kernel verification](screenshots/08-kernel-verification.png)
...
![Leapp answerfile](screenshots/09-leapp-answerfile.png)
...
![Leapp upgrade log](screenshots/10-leapp-upgrade-log.png)
...
![RHEL 9 version and kernel](screenshots/11-rhel9-version-kernel.png)
...
![Failed services](screenshots/12-systemd-failed-services.png)
...
![RHEL 9 repositories](screenshots/13-rhel9-repositories.png)
...
![Disk validation](screenshots/14-disk-validation.png)
...
![Memory validation](screenshots/15-memory-validation.png)
...
![Network validation](screenshots/16-network-validation.png)
...
![Routing validation](screenshots/17-routing-validation.png)
...
![Upgrade complete](screenshots/18-upgrade-complete.png)
